...
const Input: React.FC<InputProps> = ({
    ...
    return (
        <div className="w-full relative">
            ...
            `} id={id} disabled={disabled} type={type} {...register(id, { required })} placeholder=" " />
            <label htmlFor="" className={`absolute text-md duration-150 transform -translate-y-3 top-5 z-10 origin[0] ${formatPrice ? "left-9" : "left-4"} 
